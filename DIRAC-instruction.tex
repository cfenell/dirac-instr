...
Access to data in DIRAC requires authentication. Two options are implemented: Certificate authentication and authentication with the EGI Checkin service.
Certificate authentication is the most mature system and is described in the following.
